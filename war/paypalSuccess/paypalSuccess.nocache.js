function paypalSuccess(){
  ...
  paypalSuccess.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  paypalSuccess.onInjectionDone = function(){
    scriptsDone = true;
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_39], $intern_52);
